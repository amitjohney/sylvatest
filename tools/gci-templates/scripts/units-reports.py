...
try:
    ...
    print(input_filename + " was not found, units-report.xml will not be generated")
    exit(1)
...
for unit in data['items']:
    ...
    test_case = TestCase(env_type + ":" + unit_name, classname='sylva-unit-validation', elapsed_sec=td.total_seconds())
