...
| **root-dependency** | special unit ensuring ordered updates of all Kustomizations | All Kustomizations will depend on this Kustomization, whose name is root-dependency-<n> and changes at each update of the sylva-units Helm release. This Kustomization does not become ready before all other Kustomizations have been updated. All this ensures in a race-free way that during an update, units will be reconciled in an order matching dependendy declarations. | True | Kustomize | N/A |
