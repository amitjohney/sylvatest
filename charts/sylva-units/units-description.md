...
| **alertmanager-config** | generates the config for Alertmanager |  |  | [Helm](https://gitlab.com/sylva-projects/sylva-elements/helm-charts/sylva-alertmanager-resources.git) | 0.0.1 |
