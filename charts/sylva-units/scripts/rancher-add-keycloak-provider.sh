...
KEYCLOAK_INTERNAL_URL="https://keycloak-service.keycloak.svc.cluster.local:8443" #use for internal communication between keycloak and rancher
KEYCLOAKOIDC_CLIENT_ID="rancher"
KEYCLOAKOIDC_AUTH_ENDPOINT="$KEYCLOAK_EXTERNAL_URL/realms/$REALM/protocol/openid-connect/auth"
KEYCLOAKOIDC_ISSUER="$KEYCLOAK_INTERNAL_URL/realms/$REALM"
