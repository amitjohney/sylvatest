...
**Note well** that this way of defining a workload clusters is an expedient for early versions of Sylva. The target is to have a lifecycle for multiple workflow clusters, independent from the lifecycle
