...
The image CVE scanning capability is disabled by default in order to save resources. To enable this feature, set the environment variable `.Values.security.neuvector_scanning_enabled` to true in your `values.yaml` file:
